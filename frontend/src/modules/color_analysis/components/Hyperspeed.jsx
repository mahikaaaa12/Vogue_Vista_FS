...
const getThemeEffectOptions = (theme) => {
  ...
  return {
    ...
    colors: isDark ? {
      ...
      roadColor: 0xe7dcce,
      islandColor: 0xf8f2e8,
      background: 0xf8f2e8,
      shoulderLines: 0xc6a16a,
      brokenLines: 0xc6a16a,
      leftCars: [0xc6a16a, 0x8a7e75, 0xb38e59],
      rightCars: [0x8a7e75, 0xc6a16a, 0xd0b07a],
      sticks: 0xc6a16a
    }
  };
};

const Hyperspeed = ({ theme = 'light', effectOptions }) => {
  const hyperspeed = useRef(null);
  const appRef = useRef(null);

  const computedOptions = useMemo(() => {
    const themeOpts = getThemeEffectOptions(theme);
    if (!effectOptions) return themeOpts;
    return {
      ...themeOpts,
      ...effectOptions,
      colors: {
  ...
  useEffect(() => {
    ...
    const options = {
      ...computedOptions,
      ...effectOptions,
      colors: { ...computedOptions.colors, ...(effectOptions?.colors || {}) }
    };
