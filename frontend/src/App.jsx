...
function AppContent() {
  ...
  const [colorUserProfile, setColorUserProfile] = useState(() => {
    try {
      const saved = localStorage.getItem('vogue_vista_profile');
  ...
  const handleColorScanComplete = (undertone) => {
          ...
          <AnimatePresence mode="wait">
            ...
            {screen === 'color-results' && (
              ...
              >
                <ProtectedRoute setScreen={setScreen}>
                  <ColorResultsPage 
                    userProfile={colorUserProfile} 
                    setUserProfile={setColorUserProfile} 
                    setScreen={setScreen} 
                  />
                </ProtectedRoute>
              </motion.div>
